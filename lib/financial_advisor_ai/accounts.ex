defmodule FinancialAdvisorAi.Accounts do
  ...
  alias FinancialAdvisorAi.Accounts.{User, UserToken, UserNotifier}
  ...
  See `FinancialAdvisorAi.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `FinancialAdvisorAi.Accounts.User.password_changeset/3` for a list of supported options.
