...
if user do
  ...
  {:ok, _} =
    AI.create_email_embedding(%{
      ...
      content:
        "Hi John, my son's baseball season is starting next month. We'll need to adjust our meeting schedule around his games. Let me know what works for you.",
  ...
  {:ok, _} =
    AI.create_email_embedding(%{
      ...
      content:
        "Greg here. I've been thinking about selling my AAPL stock position. The market seems volatile and I want to take some profits. What are your thoughts?",
      sender: "greg.miller@email.com",
      recipient: "webshookeng@gmail.com",
      metadata: %{keywords: ["AAPL", "stock", "sell", "profits"]}
    })
  ...
  {:ok, _} =
    AI.create_email_embedding(%{
      ...
      content:
        "My daughter has a soccer tournament this weekend. Could we reschedule our investment review meeting to next week?",
      sender: "mike.chen@email.com",
      recipient: "webshookeng@gmail.com",
      metadata: %{keywords: ["daughter", "soccer", "tournament", "meeting"]}
    })
