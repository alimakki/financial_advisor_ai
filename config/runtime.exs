...
#
#     PHX_SERVER=true bin/financial_advisor_ai start
#
...
if config_env() == :prod do
  ...
  config :financial_advisor_ai, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :financial_advisor_ai, FinancialAdvisorAi.Mailer,
